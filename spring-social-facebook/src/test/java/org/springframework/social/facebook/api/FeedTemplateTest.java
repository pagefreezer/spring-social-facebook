...
public class FeedTemplateTest extends AbstractFacebookApiTest {
	...
	@Test
	public void getFeed() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/feed?limit=25&fields=id%2Clikes.limit%281%29" +
	...
	public void getFeed_withPagedListParameters_since() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/feed?limit=25&since=1360384019&fields=id" +
	...
	public void getFeed_withPagedListParameters_until() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/feed?limit=25&until=1360384019&fields=id" +
				"%2Clikes.limit%281%29%2Ccomments.limit%281%29%2Cfrom%2Cstory%2Cstory_tags%2Cpicture%2Clink" +
				"%2Csource%2Cname%2Ccaption%2Cdescription%2Cicon%2Cactions%2Cprivacy%2Ctype%2Cstatus_type" +
				"%2Ccreated_time%2Cupdated_time%2Cis_hidden%2Csubscribed%2Cis_expired%2Cmessage"))
				.andExpect(method(GET))
	...
	public void getFeed_withUnknownType() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/feed?limit=25&fields=id%2Clikes.limit" +
	...
	public void getFeed_forOwnerId() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/12345678/feed?limit=25&fields=id" +
	...
	public void getHomeFeed() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/home?limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("feed"), MediaType.APPLICATION_JSON));
	...
	public void getStatuses() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/statuses?limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getStatuses_forSpecificUser() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/24680/statuses?limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("user-statuses"), MediaType.APPLICATION_JSON));
	...
	public void getLinks_preOctober2012() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/links?limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getLinks_forSpecificUser() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/13579/links?limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("links"), MediaType.APPLICATION_JSON));
	...
	public void getPosts() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/posts?limit=25"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("feed"), MediaType.APPLICATION_JSON));
	...
	public void getPosts_forOwnerId() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/12345678/posts?limit=25"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("feed"), MediaType.APPLICATION_JSON));
	...
	public void getFeedEntry() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/100001387295207_123939024341978"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void updateStatus() throws Exception {
		...
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/feed"))
	...
	public void post_message() throws Exception {
		String requestBody = "message=Hello+Facebook+World";
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/123456789/feed"))
				.andExpect(method(POST))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
				.andExpect(content().string(requestBody))
				.andRespond(withSuccess("{\"id\":\"123456_78901234\"}", MediaType.APPLICATION_JSON));
	...
	public void post_link() throws Exception {
		...
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/feed")).andExpect(method(POST))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
				.andExpect(content().string(requestBody))
				.andRespond(withSuccess("{\"id\":\"123456_78901234\"}", MediaType.APPLICATION_JSON));
...
//	}
	...
	public void post_link_toAnotherFeed() throws Exception {
		String requestBody = "link=someLink&name=some+name&caption=some+caption&description=some+description&message=Hello+Facebook+World";
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/123456789/feed")).andExpect(method(POST))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
				.andExpect(content().string(requestBody))
				.andRespond(withSuccess("{\"id\":\"123456_78901234\"}", MediaType.APPLICATION_JSON));
		FacebookLink link = new FacebookLink("someLink", "some name", "some caption", "some description");
	...
	public void deleteFeedEntry() {
		...
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/123456_78901234"))
				.andExpect(method(POST))
	...
	public void searchPublicFeed() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/search?q=Dr%20Seuss&type=post&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void searchHomeFeed() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/home?q=Dr+Seuss&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("post-list"), MediaType.APPLICATION_JSON));
	...
	public void searchUserFeed_currentUser() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/feed?q=Football&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("feed"), MediaType.APPLICATION_JSON));
	...
	public void searchUserFeed_specificUser() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/123456789/feed?q=Football&limit=25"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(jsonResource("feed"), MediaType.APPLICATION_JSON));
	...
	public void getCheckins() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/posts?offset=0&limit=25&with=location"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getCheckin() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/10150431253050580"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))

...
public class BookActionsTemplateTest extends AbstractFacebookApiTest {
	...
	public void readBook() throws Exception {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/book.reads"))
	...
	public void quoteBook() throws Exception {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/books.quotes"))
			.andExpect(method(POST))
	...
	public void rateBook() throws Exception {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/books.rates"))
			.andExpect(method(POST))
	...
	public void wantsToRead() throws Exception {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/books.wants_to_read"))
			.andExpect(method(POST))

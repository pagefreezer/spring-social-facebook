...
public class BookActionsTemplateTest extends AbstractFacebookApiTest {
	...
	public void readBook() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/v2.3/me/book.reads"))
	...
	public void quoteBook() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/v2.3/me/books.quotes"))
			.andExpect(method(POST))
	...
	public void rateBook() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/v2.3/me/books.rates"))
			.andExpect(method(POST))
	...
	public void wantsToRead() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/v2.3/me/books.wants_to_read"))
			.andExpect(method(POST))

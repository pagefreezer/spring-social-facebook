...
public class UserTemplateTest extends AbstractFacebookApiTest {
	...
	public void getUserProfile_currentUser() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me"))
	...
	public void getUserProfile_specificUserByUserId() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/123456789"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getUserProfileImage() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/picture?type=normal"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getUserProfileImage_specificUserByUserId() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/1234567/picture?type=normal"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(new ClassPathResource("tinyrod.jpg", getClass()), MediaType.IMAGE_JPEG));
	...
	public void getUserProfileImage_specificUserAndType() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/1234567/picture?type=large"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
			.andRespond(withSuccess(new ClassPathResource("tinyrod.jpg", getClass()), MediaType.IMAGE_JPEG));
	...
	public void getUserPermissions() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/me/permissions"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	@Test
	public void search() {
		mockServer.expect(requestTo(GRAPH_API_FACEBOOK + "/search?q=Michael+Scott&type=user"))
			.andExpect(method(GET))
			.andExpect(header("Authorization", "OAuth someAccessToken"))
